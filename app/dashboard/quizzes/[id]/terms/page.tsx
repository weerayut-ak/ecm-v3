...
export default async function QuizTermsPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <>
      {/* เพิ่ม Script ของ Lottie บนไคลเอนต์ */}
      <Script src="https://unpkg.com/@lottiefiles/dotlottie-wc@0.9.10/dist/dotlottie-wc.js" type="module" strategy="afterInteractive" />

      <div className="max-w-lg mx-auto">
        <div className="card">
          <div className="text-center mb-6">
            {/* แทนที่ไอคอน ClipboardList ด้วยแอนิเมชั่น Lottie */}
            <div className="flex justify-center mb-4">
              <dotlottie-wc
                src="https://lottie.host/7e7264aa-c07a-460a-8bab-30aaf769920a/1MK8zQDQLo.lottie"
                style={{ width: '120px', height: '120px' }} // ปรับขนาดให้พอดี
                autoplay
                loop
              />
            </div>
