  ...
  return (
    <div 
      style={{ 
        ...
        minHeight: "100vh", 
        width: "100%",
        animation: "stageBackground 5s linear infinite" // ทำให้สีพื้นหลังเปลี่ยนตามช่วงเวลา
      }}
    >
      <style>{`
        /* นำ CSS ทั้งหมดที่คุณให้มาใส่ไว้ตรงนี้ */
        @keyframes stageBackground {
          0%, 10%, 90%, 100% { background-color: #00B6BB; }
          25%, 75% { background-color: #0094bd; }
        }
        ...
        @keyframes treeShake {
          ...
          40% { transform: rotate(4deg); } 50% { transform: rotate(-4deg); }
          60% { transform: rotate(6deg); } 75% { transform: rotate(-6deg); }
        ...
        .scene { display: flex; margin: 0 auto 80px auto; justify-content: center; align-items: flex-end; width: 400px; height: 300px; position: relative; }
        ...
        .fireplace .fire .line2 { left: 50%; margin-left: -1px; animation-delay: 0.3s; }
        .fireplace .fire .line3 { right: 0; animation-delay: 0.5s; }
        ...
        .time .night .star5 { right: 18%; bottom: 30%; } .time .night .star6 { right: 60%; bottom: 20%; }
      ...
      {/* โครงสร้าง HTML สำหรับแอนิเมชัน */}
      <div className="scene">
        <div className="time-wrapper">
          <div className="time">
            ...
            <div className="night">
              ...
              <div className="star star5 star-big"></div>
              <div className="star star6"></div>
              <div className="star star7 star-big"></div>
            </div>
          </div>
        </div>
        
        <div className="forest">
          {/* สร้างต้นไม้ 7 ต้นด้วยการ Loop ของ React เพื่อประหยัดบรรทัด */}
          {[1, 2, 3, 4, 5, 6, 7].map((num) => (
            <div key={num} className={`tree tree${num}`}>
        ...
        <div className="tent">
          ...
          <div className="door left-door"><div className="left-door-inner"></div></div>
          <div className="door right-door"><div className="right-door-inner"></div></div>
        </div>
        ...
        <div className="fireplace">
          ...
          <div className="fire">
            {/* สร้างเปลวไฟ 3 เส้น */}
            {[1, 2, 3].map((num) => (
              <div key={num} className={`line line${num}`}>
